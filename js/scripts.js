/* Comentario 
asdas dasd asd asd as
en asdas das dasd asd 
...
var edad = prompt("Por favor introduzca Edad");
...
// Operaciones Matemáticas Persolalizadas
...
var resultado = numUno == 123456;
console.log("Su Acceso es: " + resultado);
*/
...
document.write(meses[0] + " " + meses[1] + " " + meses[4]);

console.log("meses[0] + " + "meses[1] + " + "meses[4]");

alert("Sr. Usuario le muestro algunos meses");
